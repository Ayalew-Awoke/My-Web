...
export const projectsData = [
  {
    ...
    title:
      "Design and Implementation of RAG Based Legal Document Assistant System Using LLM For Ethiopia Amharic Language",
    ...
    featuredImage: `${baseUrl}projects/rag-legal/chat_welcome.png`,
    ...
    summary:
      "An intelligent retrieval-augmented legal assistant that enables Amharic speakers to query Ethiopian law in natural Amharic and receive accurate, grounded legal citations without hallucinations.",
    challenge:
      "Millions of Amharic speakers lack access to legal information. Legal documents are complex, written in formal language, and no intelligent tools exist to help citizens understand their rights. Traditional search fails completely—it doesn't understand meaning, only keywords.",
    solution:
      "I built an AI-powered legal assistant that understands questions in Amharic and retrieves accurate answers directly from Ethiopian law documents. The system combines three powerful search methods to find the most relevant legal information, then generates clear answers in Amharic.",
    whatIBuilt: [
      {
    ...
    howItWorksSteps: [
      {
        step: "1",
        title: "User Question (Amharic)",
        desc: "Citizen inputs a query in Amharic regarding legal rights, bail, contracts, or court procedures.",
      },
      {
        step: "2",
        title: "Query Processing",
        desc: "Unicode normalization, character cleaning, and query expansion for Ethiopic script nuances.",
      },
      {
        step: "3",
        title: "Hybrid Search Fusion",
        desc: "Dense semantic search (30%) + Sparse BM25 exact matching (30%) + Cross-encoder Neural Re-ranking (40%).",
      },
      {
        step: "4",
        title: "Retrieved Legal Context",
        desc: "Extracts top verified chunks from 39 Ethiopian law proclamations.",
      },
      {
        step: "5",
        title: "LLM Generation (LLaMA via GROQ)",
        desc: "Context-grounded prompt synthesizes the answer strictly based on retrieved articles.",
      },
      {
        step: "6",
        title: "Amharic Answer Delivery",
        desc: "User receives clear, grammatically accurate Amharic explanation with exact legal source citations.",
      },
    ],
    keyInnovation: {
    ...
    technologies: [
      ...
      {
        component: "AI Models & LLM",
        tech: "LLaMA 3 (via GROQ), Hugging Face Embeddings",
      },
    ...
    screenshots: [
      {
        url: `${baseUrl}projects/rag-legal/signup_modal.png`,
        title: "Authentication & Sign Up Modal",
        caption:
          "Ethiopic interface with user registration, login, and secure credentials management.",
      },
      {
        url: `${baseUrl}projects/rag-legal/chat_welcome.png`,
        title: "Assistant Welcome Interface",
        caption:
          "Initial screen guiding citizens on asking legal questions in Amharic.",
      },
      {
        url: `${baseUrl}projects/rag-legal/chat_answer_citation.png`,
        title: "Legal Query & Source Citation",
        caption:
          "System answering a constitutional rights question with verified legal source citations.",
      },
      {
        url: `${baseUrl}projects/rag-legal/chat_safeguard.png`,
        title: "Hallucination Safeguard Fallback",
        caption:
          "Active fallback refusing out-of-scope queries to maintain 100% legal integrity.",
      },
    ],
  },
  {
    ...
    title:
      "Finetuning Automatic Speech Recognition (ASR) System for Amharic Language",
    category: "Speech Technologies / Deep Learning",
    scope:
      "Internship Project · Information Network Security Administration (INSA)",
    date: "Dec 2025 – Mar 2026",
    team: "Ayalew Awoke Bitew (Computer Engineering Intern)",
    featuredImage: `${baseUrl}projects/asr-amharic/actual_vs_predicted.png`,
    githubUrl: "https://github.com/Ayalew-Awoke",
    stats: [
    ...
    summary:
      "Comparative fine-tuning and empirical evaluation of Wav2Vec2 and OpenAI Whisper architectures on a custom Amharic speech dataset for low-resource automatic speech transcription.",
    challenge:
      "Amharic is spoken by tens of millions of people, yet speech recognition technology for it remains far behind English and other high-resource languages. Existing ASR systems are built and optimized for languages with massive labeled datasets — Amharic has neither the data volume nor the research attention. Add in accent variation, background noise, and Amharic's rich morphology, and most modern ASR models simply fail to produce usable transcriptions.",
    solution:
      "We fine-tuned two state-of-the-art ASR architectures — Wav2Vec2 and Whisper — on a custom-built Amharic speech dataset, adapting each model's internal representations to Amharic's acoustic and linguistic patterns. Rather than building a model from scratch, we leveraged transfer learning to make pre-trained multilingual/self-supervised models understand Amharic speech accurately.",
    whatIBuilt: [
      {
        title: "Data Pipeline",
        points: [
    ...
    howItWorksSteps: [
      {
        ...
        desc: "Aggregated broadcast news, interviews, and parliamentary debates from CAC and YouTube.",
      },
      {
        step: "2",
        title: "Audio Extraction & Segmentation",
        desc: "WAV conversion, 16kHz resampling, and 30-second window slicing.",
      },
      {
        step: "3",
        title: "Feature Extraction",
        desc: "Log-mel spectrograms (Whisper) and raw waveform normalization (Wav2Vec2).",
      },
      {
        step: "4",
        title: "Model Fine-Tuning",
        desc: "PyTorch & HuggingFace training using CTC loss and Seq2Seq cross-entropy loss.",
      },
      {
        step: "5",
        title: "Comparative Evaluation",
        desc: "Benchmarked WER & CER across varying noise levels and speaker profiles.",
      },
      {
        step: "6",
        title: "Amharic Transcription",
        desc: "Delivers faithful, phonetically grounded Ethiopic text transcriptions.",
      },
    ],
    keyInnovation: {
    ...
    technologies: [
      ...
      { component: "Architectures", tech: "OpenAI Whisper, Wav2Vec2 (XLS-R)" },
      {
        ...
        tech: "Hugging Face Transformers, PyTorch, Torchaudio",
      },
    ...
    screenshots: [
      {
        url: `${baseUrl}projects/asr-amharic/actual_vs_predicted.png`,
        title: "Actual vs. Predicted Evaluation",
        caption:
          "Detailed sentence-by-sentence prediction comparison showing individual WER and CER scores.",
      },
      {
        url: `${baseUrl}projects/asr-amharic/whisper_metrics.png`,
        title: "Whisper Overall Metrics",
        caption:
          "Empirical evaluation logs showing Whisper reaching WER of 0.135 and CER of 0.039.",
      },
      {
        url: `${baseUrl}projects/asr-amharic/wav2vec2_metrics.png`,
        title: "Wav2Vec2 Overall Metrics",
        caption:
          "Benchmark test metrics for Wav2Vec2 showing WER of 0.153 and CER of 0.058.",
      },
      {
        url: `${baseUrl}projects/asr-amharic/audio_predictions.png`,
        title: "Batch Audio Transcriptions",
        caption:
          "Predicted Amharic transcriptions across test audio recordings (audio_0014.wav, etc.).",
      },
      {
        url: `${baseUrl}projects/asr-amharic/training_progress.png`,
        title: "Training Execution Logs",
        caption: "PyTorch iteration progress bar and loss convergence monitor.",
      },
    ],
  },
  {
    ...
    featuredImage: `${baseUrl}projects/gondar-ttrs/package_list.jpeg`,
    githubUrl: "https://github.com/Ayalew-Awoke",
    stats: [
    ...
    summary:
      "A centralized, web-based reservation platform for historical attractions in Gondar, replacing manual ticketing with digital booking, inventory tracking, and integrated Chapa online payments.",
    challenge:
      "Gondar is one of Ethiopia's most historically significant cities, home to the UNESCO-listed Fasil Ghebbi (Royal Enclosure). Tourist ticketing was still entirely manual — paper-based sales, registration, and reporting. This led to long queues during peak seasons like Timkat, frequent data-entry errors, lost/damaged records, poor coordination between attraction managers, vendors, and tourism offices, and no visibility into visitor trends or sales data for decision-making. Tourists had no way to book ahead or pay online.",
    solution:
      "We replaced the manual workflow with a centralized, web-based reservation platform (TTRS). Tourists can browse attractions, book tickets, and pay online in one place; administrators gain full control over inventory, user accounts, and analytical reporting from a single dashboard.",
    whatIBuilt: [
      {
    ...
    howItWorksSteps: [
      {
        step: "1",
        title: "Tourist Browsing",
        desc: "Visitor explores historical attractions like Simien Mountains, Guzara Castle, and Gorgora.",
      },
      {
        step: "2",
        title: "Booking Request",
        desc: "Selects tour date and ticket quantities; Booking Engine validates capacity limits.",
      },
      {
        step: "3",
        title: "Chapa Payment Gateway",
        desc: "Handoff to Chapa API for secure payment processing via test/live banking channels.",
      },
      {
        step: "4",
        title: "Transaction Validation",
        desc: "Webhook callback confirms payment; booking status updates to 'Confirmed'.",
      },
      {
        step: "5",
        title: "Receipt & Notifications",
        desc: "Instant digital receipt issued with unique booking ID; SMS/email confirmation dispatched.",
      },
      {
        step: "6",
        title: "Admin Monitoring",
        desc: "Admins inspect passenger manifests, capacity schedules, and financial revenue charts.",
      },
    ],
    keyInnovation: {
    ...
    technologies: [
      {
        ...
        tech: "HTML5, CSS3, JavaScript (ES6+), Bootstrap Responsive Grid",
      },
      { component: "Backend Logic", tech: "PHP (Modular MVC Architecture)" },
      { component: "Database", tech: "MySQL (Tested via XAMPP/Apache)" },
      {
        component: "Payment Gateway",
        tech: "Chapa Financial Technologies API",
      },
      {
        component: "Modeling & Design",
        tech: "UML (Use Case, Sequence, Activity, Class Diagrams)",
      },
      {
        component: "Security",
        tech: "Bcrypt password hashing, prepared SQL statements, XSS sanitization",
      },
    ],
    resultsList: [
    ...
    screenshots: [
      {
        url: `${baseUrl}projects/gondar-ttrs/package_list.jpeg`,
        title: "Traveller Package Catalog",
        caption:
          "Catalog showcasing packages including Simien Mountains National Park and Guzara Castle.",
      },
      {
        url: `${baseUrl}projects/gondar-ttrs/package_details.png`,
        title: "Attraction Detail View",
        caption:
          "Detailed package breakdown for Gorgora Lake Tana with itineraries and pricing.",
      },
      {
        url: `${baseUrl}projects/gondar-ttrs/admin_dashboard.jpeg`,
        title: "Admin Management Dashboard",
        caption:
          "System administrator portal for package creation, pricing, and attraction configuration.",
      },
      {
        url: `${baseUrl}projects/gondar-ttrs/chapa_checkout.jpeg`,
        title: "Chapa Payment Gateway Integration",
        caption:
          "Secure payment processing interface supporting test card and bank account channels.",
      },
      {
        url: `${baseUrl}projects/gondar-ttrs/chapa_receipt.jpeg`,
        title: "Payment Confirmation Receipt",
        caption:
          "Verified digital receipt issued upon successful completion of a booking payment.",
      },
      {
        url: `${baseUrl}projects/gondar-ttrs/use_case_diagram.png`,
        title: "System UML Use Case Diagram",
        caption:
          "Architectural blueprint detailing interactions between Tourist and System Admin actors.",
      },
    ],
  },
  {
    ...
    featuredImage: `${baseUrl}projects/rfid-tracking/arduino-uno.svg`,
    ...
    summary:
      "A hardware-software simulation bridging RFID-based unique tag identification with desktop device management logic for automated tracking of electronic hardware inventory.",
    challenge:
      "Managing and identifying electronic devices can become complex when information is handled manually. Equipment logs in labs, universities, and offices frequently suffer from missing serial records, unauthorized removal, and inefficient audits. This project explored how RFID technology could be used to create a more organized approach to device identification and tracking, with the complete system represented and evaluated through simulation.",
    solution:
      "The concept was to design a device-tracking system based on RFID identification, where each electronic device is represented by a unique RFID tag identity. The captured UID is transmitted to a desktop management application, creating a seamless connection between physical hardware identification and digital record tracking.",
    whatIBuilt: [
      {
    ...
    howItWorksSteps: [
      {
        step: "1",
        title: "Tag Proximity Detection",
        desc: "Passive 13.56 MHz RFID tag enters electromagnetic field generated by MFRC522 antenna.",
      },
      {
        step: "2",
        title: "UID Acquisition",
        desc: "Reader initiates anti-collision protocol and acquires unique 4-byte hexadecimal card identifier.",
      },
      {
        step: "3",
        title: "SPI Bus Transmission",
        desc: "MFRC522 pushes raw UID bytes across MOSI/MISO to Arduino Uno digital registers.",
      },
      {
        step: "4",
        title: "Firmware Processing",
        desc: "Arduino sketch parses UID array and serializes data through UART at 9600 baud.",
      },
      {
        step: "5",
        title: "Desktop Application Binding",
        desc: "Management software matches UID against database records to retrieve device profile.",
      },
      {
        step: "6",
        title: "State Update & Audit",
        desc: "Records device status (Available, In-Use, In-Transit) and commits timestamped log entry.",
      },
    ],
    keyInnovation: {
    ...
    technologies: [
      ...
      { component: "RFID Module", tech: "MFRC522 13.56 MHz RFID Transceiver" },
      {
        ...
        tech: "SPI (Serial Peripheral Interface) & UART Serial",
      },
      {
        component: "Embedded Firmware",
        tech: "C / C++ (Arduino IDE Framework)",
      },
      {
        component: "Simulation Platform",
        tech: "Wokwi Embedded Systems Simulator",
      },
      {
        component: "Tracking Logic",
        tech: "Desktop Inventory Management Architecture",
      },
    ],
    resultsList: [
    ...
    screenshots: [
      {
        url: `${baseUrl}projects/rfid-tracking/arduino-uno.svg`,
        title: "Arduino Uno RFID Prototype",
        caption:
          "Arduino Uno board used as the microcontroller foundation for the RFID device tracking simulation.",
      },
    ],
  },
];
